...
export default function RootLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <html
      lang="es-AR"
      // Noche es el DEFAULT server-rendered (panel dark-first): `data-theme="dark"`
      // + `.theme-dark`. Si el usuario eligió claro, el pre-paint de abajo le saca
      // la clase + pone data-theme="light" ANTES del primer paint (sin flash), y el
    ...
    >
      <head>
        {/*
          Scripts inline pre-paint para aplicar preferencias persistidas (a11y +
          tema) antes del primer render. Evitan FOUC entre el default
          server-rendered (text-size-md, Noche) y la preferencia del usuario.
          Sincronizados con stores/a11y.ts y stores/theme.ts.
        */}
