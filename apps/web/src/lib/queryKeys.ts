/**
 * Factory de query keys de TanStack Query (apps/web/AGENTS.md: TanStack v5
 * para server-state). Keys jerárquicas y tipadas en un solo lugar: las
 * queries y la invalidación leen de acá, así no se desincronizan strings
 * sueltos regados por la app.
 *
