 ...
 * headline editorial + los highlights. Usa el `BottomSheet` compartido. Cerrar
 * el día de verdad (regenerar con el LLM) es fase de backend.
 */
    ...
    <BottomSheet open={open} onClose={onClose}>
      <View className="gap-5 px-6 pb-6 pt-5">
        <View className="gap-1">
          ...
          <Text className="text-body-sm text-ink-soft">{formatHoyDate(new Date(recap.date))}</Text>
        </View>
