...
> **Deuda detectada (fuera de este plan)**: la landmine de `AGENTS.md` (sección "Editing conventions") todavía dice que `core/security.py` está en `NotImplementedError`, pero #62 ya lo implementó. Corregir ese resumen en un PR aparte de docs raíz (requiere OK humano por ser `.md` raíz).
